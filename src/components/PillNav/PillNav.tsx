...
const PillNav: React.FC<PillNavProps> = ({
  ...
  useEffect(() => {
    ...
    const handleIntersect = (entries: IntersectionObserverEntry[]) => {
      entries.forEach((entry) => {
        if (entry.isIntersecting) {
          ...
          // Ensure we add the # so it matches your hrefs exactly
          const idWithHash = `#${entry.target.id}`; 
          setScrollActive(idWithHash);
        }
      });
    }; 
    ...
    // This looks for any <section id="something"> on your page
